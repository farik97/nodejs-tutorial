...
handlers.userCreate = (data, callback) =>{}
handlers.userEdit = (data, callback) => {}
handlers.userDeleted = (data, callback) => {}
    ...
    if (phone) {
        ...
        handlers._tokens.verifyToken(token, phone, (tokenIsValid)=>{
            if(tokenIsValid){
                ...
                _data.read('users', phone, function(err, data){
                    if(!err && data){
                        // remove the hashed password from teh suer object before returning it
